  ...
  test("POST /blogPosts", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postPublishedDate: CREATE_RESULT.postPublishedDate.toISOString(),
      });
  });
      ...
      .expect([
        {
          ...
          postPublishedDate:
            FIND_MANY_RESULT[0].postPublishedDate.toISOString(),
        },
      ]);
  });
  ...
  test("GET /blogPosts/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        postPublishedDate: FIND_ONE_RESULT.postPublishedDate.toISOString(),
      });
  });
